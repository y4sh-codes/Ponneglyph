...
CREATE INDEX IF NOT EXISTS idx_volunteer_interests ON volunteer USING gin (interests);
CREATE INDEX IF NOT EXISTS idx_volunteer_connections ON volunteer USING gin (connections);
CREATE INDEX IF NOT EXISTS idx_volunteer_inbox_requests ON volunteer USING gin (inbox_requests);
CREATE INDEX IF NOT EXISTS idx_volunteer_sent_requests ON volunteer USING gin (sent_requests);
CREATE INDEX IF NOT EXISTS idx_volunteer_post_engagement ON volunteer USING gin (post_engagement);
CREATE INDEX IF NOT EXISTS idx_volunteer_topic_engagement ON volunteer USING gin (topic_engagement);
CREATE INDEX IF NOT EXISTS idx_volunteer_pending_inbox ON volunteer USING gin (inbox_requests)
